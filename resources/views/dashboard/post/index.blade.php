                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row align-items-start">
                                <div class="col-sm">
                                    <div>
                                        <a href="{{route('posts.create')}}"><button type="button" class="btn btn-light mb-4" data-bs-toggle="modal" data-bs-target="#addInvoiceModal"><i class="mdi mdi-plus me-1"></i> Add Post</button></a>
                                    </div>
                                </div>
                                ...
                                <table class="table align-middle table-nowrap table-check">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td> {{  Str::limit($post->problematic, 10)  }} </td>
                                            
                                            <td> {{ Str::limit($post->content, 6) }} </td>
                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end">
                                                        ...
                                                        <li><a class="dropdown-item" href="{{route('posts.show', $post)}}">Print</a></li>
                                                        <li><a class="dropdown-item" href="{{route('posts.destroy', $post)}}">Delete</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr><!-- end tr -->                                            
                                ...
                                <div class="col-sm-6">
                                    <ul class="pagination pagination-rounded justify-content-center justify-content-sm-end mb-sm-0">
                                        <li class="page-item disabled">
                                            <a href="{{ $posts->previousPageUrl() }}" class="page-link"><i class="mdi mdi-chevron-left"></i></a>
                                        </li>
                                        ...
                                        <li class="page-item">
                                            <a href="{{ $posts->nextPageUrl() }}" class="page-link"><i class="mdi mdi-chevron-right"></i></a>
                                        </li>
                                    </ul>
                                </div><!-- end col -->
                            </div><!-- end row -->
