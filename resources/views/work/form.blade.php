...
@section('title', $work->exists ? 'Modifier une Rea' : 'Ajouter une Rea' )
            ...
            <div class="col col--sm-8 col--sm-offset-2 col--md-12 col--md-offset-0 col--lg-10 col--lg-offset-1">
                <div class="row">
                    <div class="col col--md-12">
                        <h2 class="home__contacts-title"> {{ $work->exists ? 'Modifier une Rea' : 'Ajouter une Rea' }} </h2>
                    </div>
                    ...
                    <div class="col col--md-12">
                        ...
                        <form  action="{{route($work->exists ? 'works.update' : 'works.store', $work)}}" method="POST" class="form" >  <!-- id="contact-form" -->
                            @csrf
                            @method($work->exists ? 'PUT' : 'POST')
                            
                            <div class="row">
                                <div class="col field">
                                  <input id="title" name="title" type="text" value="{{old('title', $work->title)}}" class="field__input field--name required" required>
                            ...
                            <div class="row">
                                <div class="col field">
                                  <input id="problematic" type="text" name="problematic" value="{{old('problematic', $work->problematic)}}" class="field__input field--email required" required>
                            ...
                            <div class="row">
                                <div class="col field">
                                  <input id="tasks" name="tasks" type="text" value="{{old('tasks', $tasks)}}" class="field__input field--name required" required>
                                  <label for="tasks" class="field__label">Tasks (Taches) </label>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col field">
                                  <input id="link" name="link" type="text" value="{{old('tasks', $work->link)}}" class="field__input field--name required" required>
                                  <label for="link" class="field__label">Lien</label>
                                </div>
                            </div>
                         
                            <div class="row">
                                <div class="col field">
                                  <textarea id="markdown-editor" name="description" class="markdown-editor"  class="field__textarea field--message required" required> {{old('content', $work->description)}} </textarea>
